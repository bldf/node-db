// const aa = require('../../util/tools.js');
console.log('99999999999999999999999999999',this._T) ;
console.log('88888888888888888888888888888',_T) ;
describe('测试断言库jasmine，测试tools.js的api',function(){
    ...
    it('测试_T.validate()',function(){
        ...
        console.log(re) ;
        expect(re).toEqual({re:false,info:'不能为空'});
